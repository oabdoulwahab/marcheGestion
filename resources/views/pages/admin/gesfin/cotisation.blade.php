                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('cotisation.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="montantTotal" name="montant_total"
                                            placeholder="Entrez le montant total" required>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="dateFin" required name="date_fin">
                                    </div>
